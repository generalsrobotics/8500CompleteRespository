...
@Autonomous(name="REDVuforiaAutonomous", group = "Linear Opmode")
@Disabled
public class ConceptVuforiaDriveToTargetWebcam extends LinearOpMode
{
    ...
    @Override public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            //level 1
            if (targetFound && targetBearing >= -20 && targetBearing <= -8 ) {
                ...
                break;
                //level 2
            } else if (targetFound && targetBearing >= -4 && targetBearing <= 7){
                ...
                break;
                //level 3
            }else if(targetFound && targetBearing >= 10 && targetBearing <= 20) {
